...
public class Combat
{
    ...
    [Header("Tertiary Weapon")]
    public Weapon TertiaryWeapon = null;
    public bool TertiaryWeaponHasMags = false;
    Weapon PreviousTertiaryWeapon = null;
    ...
    public Combat(Weapon Weapon1, Weapon Weapon2, Weapon Weapon3)
    {
        PrimaryWeapon = Weapon1;
        SecondaryWeapon = Weapon2;
        TertiaryWeapon = Weapon3;
    }
    ...
    public bool CheckWeaponHasMags(Inventory inventory, int WeaponSlot)
    {
        switch (WeaponSlot)
        {
            ...
            case 2:
                ...
                break;
            case 3:
              TertiaryWeaponHasMags = false;
                foreach (var item in TertiaryWeapon.CompatableMagazines)
                {
                    if (inventory.ItemInInventory(item))
                    {
                        TertiaryWeaponHasMags = true;
                        return true;
                    }
                }
                break;
    ...
    private void CheckWeaponUpdated()
    {
        ...
        if (TertiaryWeapon != PreviousTertiaryWeapon)
            TertiaryWeapon.LoadPrefabs();
        PreviousTertiaryWeapon = TertiaryWeapon;
    }
    ...
    private void CheckCurrentWeapon()
    {
        ...
        if (CurrentWeapon == TertiaryWeapon)
            Weapon3IsCurrent = true;
    }
}